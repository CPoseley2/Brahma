...
export class LoginView {
  ...
  mount() {
    this.root.innerHTML = `<main class="login-shell"><section class="login-card"><p class="eyebrow dark">Fair Oaks Soccer Club</p><h1>U6 Team Hub</h1><p class="login-intro">Private team information for invited coaches and families.</p>${this.vm.completingLink ? this.#linkCompletion() : this.#signInOptions()}<div id="loginStatus" aria-live="polite"></div><div id="unauthorizedActions"></div></section></main>`;
